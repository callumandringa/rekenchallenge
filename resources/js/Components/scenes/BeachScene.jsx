...
const BeachScene = ({ onSolve, vragen, solvedObjects }) => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/StrandScene.jpg')" }}
    >
      <h2 className="text-4xl text-center text-white p-6 font-bold drop-shadow-lg">Strand</h2>
