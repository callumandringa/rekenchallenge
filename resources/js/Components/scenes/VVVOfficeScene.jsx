...
const VVVOfficeScene = ({ onSolve, vragen, solvedObjects }) => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/OfficeScene.jpg')" }}
    >
      <h2 className="text-4xl text-center text-white p-6 font-bold drop-shadow-lg">VVV-kantoor</h2>
