...
const CitySquareScene = ({ onSolve, vragen, solvedObjects }) => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/BankScene.jpg')" }}
    >
      <h2 className="text-4xl text-center text-white p-6 font-bold drop-shadow-lg">Stadsplein</h2>
